!(function (t) {
  ...
  (i.m = t),
    ...
    (i.p = "//assets0.headwayapp.co/assets/packs/"),
    i((i.s = 1112));
})({
  1112: function (t, e, i) {
    "use strict";
    ...
    (n = (function () {
      ...
      return (
        ...
        (n.prototype.postMessage = function () {
          var e, i, n;
          return (
            (i = (e = Array.prototype.slice.call(arguments)).shift()),
            (n = e),
            this.iframe.contentWindow.postMessage([t, i, n], "*")
          );
        }),
        (n.prototype.log = function () {
          if (this.localOptions.debug)
            return console.log("[Headway Debug]", arguments);
        }),
        ...
        (n.prototype.realInit = function (t) {
          if (
            ...
            ("v8" === this.position.version || t.__component) &&
              (this.newWidgetPositioning = !0),
            t.__component && (this.newBadgePositioning = !0),
            (this.accountId = this.localOptions.account),
            (this.protocol = this.localOptions.protocol
              ? this.localOptions.protocol + ":"
              : "https:"),
            (this.localOptions.enabled =
              null == this.localOptions.enabled || this.localOptions.enabled),
            this.destroy(),
            this.localOptions.enabled)
          ) {
            if (null == this.accountId)
              return this.warn(
                "Cannot load widget, 'HW_config.account' is missing"
              );
            if (this.localOptions.apiMode)
              this.localOptions.selector &&
                (delete this.localOptions.selector,
                this.warn("When in apiMode, 'selector' option is ignored")),
                this.localOptions.trigger &&
                  (delete this.localOptions.trigger,
                  this.warn("When in apiMode, 'trigger' option is ignored"));
            else if (null == this.localOptions.selector)
              return this.warn(
                "Cannot load widget, 'HW_config.selector' is missing"
              );
            return (
              (this.visible = !1),
              (this.currentAlign = "left"),
              (this.eyecatcherLevel = 0),
              null != this.localOptions.callbacks &&
                (this.localCallbacks = this.localOptions.callbacks),
        ...
        (n.prototype.readWidgetPosition = function (t) {
          ...
          return t.widgetPosition
            ? ((e = /^([a-z]+)-([a-z]+)$/.exec(t.widgetPosition))[0],
              (s = e[1]),
              { x: e[2], y: s, version: "v8" })
            : "right-center" === (null != (i = t.position) ? i.x : void 0)
            ? { x: "right", y: "center", version: "v8" }
            : {
        ...
        (n.prototype.destroy = function () {
          ...
          return (
            this.removeFromDOM(
              null != (t = this.elements) ? t.badgeCont : void 0
            ),
            this.removeFromDOM(this.iframeCont),
            (this.widgetIsReady = !1),
            (this.badgeIsReady = !1)
          );
        }),
        ...
        (n.prototype.setup = function () {
          return (
            ...
            this.badgeEl || this.localOptions.apiMode
              ? (this.createElements(),
                this.makeInaccessible(),
                window.addEventListener("message", this.postMessageReceive))
              : this.warn("Element provided by selector does not exist.")
          );
        }),
        (n.prototype.createElements = function () {
          ...
          return (
            ...
            this.localOptions.apiMode ||
              ...
              this.newBadgePositioning &&
                this.elements.badgeCont.classList.add("HW_absolute"),
              this.elements.badgeCont.classList.add("HW_badge_cont"),
              /top-/.test(this.badgePosition) &&
                this.elements.badgeCont.classList.add("HW_top"),
              /bottom-/.test(this.badgePosition) &&
                this.elements.badgeCont.classList.add("HW_bottom"),
              /-left/.test(this.badgePosition) &&
                this.elements.badgeCont.classList.add("HW_left"),
              /-right/.test(this.badgePosition) &&
                this.elements.badgeCont.classList.add("HW_right"),
              /-center/.test(this.badgePosition) &&
                this.elements.badgeCont.classList.add("HW_vcenter"),
              /^center$/.test(this.badgePosition) &&
                this.elements.badgeCont.classList.add("HW_center"),
              /center-/.test(this.badgePosition) &&
                this.elements.badgeCont.classList.add("HW_hcenter"),
              this.elements.badgeCont.addEventListener(
                "click",
                this.toggle,
                !1
              ),
          ...
          return (
            ...
            e.forEach(
              ...
              function (e) {
                ...
                return "string" ===
                  typeof (s =
                    (null != (n = i.localOptions.styles) ? n[e] : void 0) || {})
                  ? (t.style.cssText = s)
        ...
        (n.prototype.initIframe = function () {
          return this.iframeCont &&
            this.iframeCont.dataset.account === this.accountId
            ? (document.body.contains(this.iframeCont) ||
                this.getIframeTarget().appendChild(this.iframeCont),
              this.iframeData
                ? this.widgetReady(this.updateIframeState(this.iframeData))
                : void 0)
            : this.resetIframe();
        }),
        (n.prototype.updateIframeState = function (t) {
          return (
            (t.state = this.state), (t.badgeCount = this.getUnseenCount()), t
          );
        }),
        ...
        (n.prototype.destroyIframe = function () {
          return (
            this.removeFromDOM(this.iframeCont),
            (this.iframeCont = this.iframe = null),
        ...
        (n.prototype.createIframe = function () {
          ...
          return (
            ...
            (t.sandbox =
              "allow-same-origin allow-scripts allow-top-navigation allow-popups allow-forms allow-popups-to-escape-sandbox"),
        ...
        (n.prototype.getIframeUrl = function () {
          var t, e;
          return (
            (t = this.localOptions.debugHost || "headway-widget.net"),
            (e = this.protocol + "//" + t + "/widgets/" + this.accountId),
            null != this.localOptions.token &&
              (e = e + "?token=" + this.localOptions.token),
            e
          );
        }),
        ...
        (n.prototype.setAction = function (t, e) {
          if (
            ("onShowDetails" === t.event && this.onShowDetails(t.data),
            "onReadMore" === t.event)
          )
            return this.onReadMore(t.data);
        }),
        ...
        (n.prototype.ga = function (t, e, i) {
          if (
            this.localOptions.googleAnalytics &&
        ...
        (n.prototype.postMessageReceive = function (e) {
          ...
          if (
            ...
            (o = i[1]),
            (n = i[2]),
            (null != (a = this.iframe) ? a.contentWindow : void 0) ===
              e.source && s === t)
          )
            switch (o) {
              case "setHeight":
        ...
        (n.prototype.attachListeners = function () {
          ...
          if (
            ...
            for (t = 0, e = (i = this.elements.trigger).length; t < e; t++)
              i[t].addEventListener("click", this.toggle);
          return this.log(
            "Widget.attachListeners#triggers",
            this.elements.trigger
          );
        }),
        ...
        (n.prototype.lsGetState = function () {
          ...
          return {
            seen: function () {
              var e, i, n, s;
              for (
                s = [], e = 0, i = (n = this.lsGet("seen")).length;
                e < i;
                e++
              )
                (t = n[e]), s.push(parseInt(t));
              return s;
            }.call(this),
            read: function () {
              var e, i, n, s;
              for (
                s = [], e = 0, i = (n = this.lsGet("read")).length;
                e < i;
                e++
              )
                (t = n[e]), s.push(parseInt(t));
          ...
          try {
            return e instanceof Array
              ? null != (n = window.localStorage)
                ? n.setItem(this.lsKey(t), e.slice(-30).join(","))
                : void 0
              : null != (s = window.localStorage)
              ? s.removeItem(this.lsKey(t))
              : void 0;
          } catch (o) {
        ...
        (n.prototype.setState = function (t) {
          return (
            (this.state = t),
            "server" !== this.remoteOptions.activeStorage && this.lsSetState(t),
            this.onWidgetUpdate(this),
            this.log("Widget.setState", t)
          );
        }),
        ...
        (n.prototype.getPosition = function () {
          ...
          return (
            ...
            (a = { top: parseInt(e.badge.height), right: s - e.badge.width }),
            {
              y:
                e.badge.top + e.frame.height >
                document.documentElement.clientHeight,
              x: e.badge.left + s > document.documentElement.clientWidth,
            },
            (o = { x: "right", y: "bottom" }),
            e.badge.left + s > document.documentElement.clientWidth &&
              e.badge.left - s >= 0 &&
              (o.x = "left"),
            e.badge.top + e.frame.height >
              document.documentElement.clientHeight &&
              e.badge.top - e.frame.height >= 0 &&
              (o.y = "top"),
            (null != (i = this.localOptions.position) ? i.y : void 0) &&
              (o.y = i.y),
        ...
        (n.prototype.newSetPosition = function (t) {
          ...
          if (
            ...
            return (
              this.iframeCont.offsetHeight,
              this.iframeCont.classList.remove("HW_notransition")
            );
        }),
        (n.prototype.classicSetPosition = function () {
          ...
          return (
            ...
            (n = s[2]),
            "right" === (i = s[3]).x
              ? (this.iframeCont.style.left = t.left + "px")
              : "left" === i.x
              ? (this.iframeCont.style.left = t.left - n.right + "px")
              : (this.iframeCont.style.left = "0px"),
            "top" === i.y
              ? (this.iframeCont.style.top =
                  t.top + n.top - e.height - t.height + "px")
              : (this.iframeCont.style.top = t.top + n.top + "px")
          );
        }),
        (n.prototype.setPosition = function () {
          return this.newWidgetPositioning
            ? this.newSetPosition()
            : this.classicSetPosition();
        }),
        ...
        (n.prototype.hide = function () {
          if (this.visible)
            return (
              (this.visible = !1),
              this.iframeCont.classList.remove("HW_visible"),
        ...
        (n.prototype.triggerCallback = function (t, e) {
          ...
          if (
            ...
            return (
              ...
              (i = function () {
                var i;
                return null != (i = n.localCallbacks[t])
                  ? i.apply(n, e)
                  : void 0;
              }),
              setTimeout(i, 0)
        ...
        (n.prototype.toggle = function (t) {
          if (
            (t && (t.preventDefault(), t.stopPropagation()), this.widgetIsReady)
          )
            return this.visible
              ? this.hide()
              : (this.show(), this.onShowWidget());
        }),
        (n.prototype.showWidgetBadge = function () {
          return (
            (this.badgeIsReady = !0),
            this.setBadge(this.getUnseenCount()),
            this.onShowWidgetBadge(this.getUnseenCount())
          );
        }),
        (n.prototype.setBadge = function (t) {
          var e;
          if (
            (this.setUnseenCount(t), this.badgeIsReady) &&
            !this.localOptions.embed
          )
            return t >= 1
              ...
              : (this.removeEyecatcher(),
                this.remoteOptions.softHide
                  ? (this.elements.badge.classList.remove("HW_visible"),
                    this.elements.badge.classList.add("HW_softHidden"),
                    this.setStyles(this.elements.badge, "badge", "softHidden"),
                    (this.elements.badge.innerText = ""))
                  : (window.setTimeout(
                      ((e = this),
                      function () {
                        return e.elements.badgeCont.classList.remove(
                          "HW_visible"
                        );
                      }),
                      300
        ...
        (n.prototype.setHeight = function (t) {
          return this.newWidgetPositioning
            ? this.newSetHeight(t)
            : this.classicSetHeight(t);
        }),
        (n.prototype.newSetHeight = function (t) {
          if (
            this.currentHeight !== t.height &&
            ((this.currentHeight = t.height),
            this.setIframeHeight(t.height),
            this.visible)
          )
            return this.newSetPosition(!0);
        }),
        (n.prototype.setIframeHeight = function (t) {
          return (
            (this.iframe.style.height = t + "px"),
            (this.iframeCont.style.height = t + "px")
          );
        }),
        (n.prototype.classicSetHeight = function (t) {
          ...
          return (
            ...
            this.iframeCont.getBoundingClientRect().y + e > window.innerHeight
              ? ((this.widgetPositionUpdated = !0), this.setPosition())
              : this.widgetPositionUpdated
              ? (this.setPosition(), (this.widgetPositionUpdated = !1))
              : void 0
          );
        }),
        (n.prototype.widgetReady = function (t) {
          ...
          if (
            ...
            this.widgetIsReady ||
              ((this.widgetIsReady = !0), this.onWidgetReady(this)),
            this.onWidgetUpdate(this),
            this.localOptions.embed)
          )
            return this.show();
        ...
        (n.prototype.getChangelogs = function () {
          var t, e, i, n, s, o;
          for (e = 0, i = (n = this.changelogs).length; e < i; e++)
            ((t = n[e]).read =
              ((s = t.id), a.call(this.lsGet("read"), s) >= 0)),
              (t.seen = ((o = t.id), a.call(this.lsGet("seen"), o) >= 0));
        ...
        (n.prototype.setUnseenCount = function (t) {
          return (
            (this.unseenCount = t),
            (this.elements.badge.dataset.countUnseen = t > 0 ? t : "")
          );
        }),
        (n.prototype.getPrivateToken = function () {
          if (!this.widgetIsReady)
            throw "getPrivateToken has to be called after `onWidgetReady` callback";
        ...
        (n.prototype.setupEyecatcher = function () {
          ...
          return (
            ...
            this.elements.animate.setAttribute(
              "href",
              this.protocol + "//cdn.headwayapp.co/headway-animate.css"
            ),
            document.body.appendChild(this.elements.animate),
            (t = [
              "blank",
              "pulse",
              "jello",
          ...
          return (
            ...
            window.setInterval(
              ...
              function () {
                var n;
                return (
                  (n = "HW_" + t[i.eyecatcherLevel]),
                  t.length === i.eyecatcherLevel && (n = t[t.length - 1]),
                  i.elements.badge.classList.add(n),
                  window.setTimeout(function () {
                    if ((i.elements.badge.classList.remove(n), (e += 1) >= 5))
                      return (
                        (e = 0),
                        (i.eyecatcherLevel = i.eyecatcherLevel + 1),
                        i.elements.badge.classList.remove(n)
                      );
                  }, 1e3)
                );
              }),
        ...
        (n.prototype.removeEyecatcher = function () {
          return (this.elements.badge.className = "HW_badge");
        }),
